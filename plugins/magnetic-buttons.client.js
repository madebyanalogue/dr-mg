export default defineNuxtPlugin(() => {
  function initMagneticEffect() {
    ...
    const resetMagnet = e => {
      ...
      if (inner) {
        gsap.to(inner, { x: "0em", y: "em", ease: "elastic.out(1, 0.3)", duration: 2, clearProps: "all" })
      }
    }
  ...
  // Re-initialize when new content loads (like SVGs)
  window.addEventListener('svg-loaded', initMagneticEffect)
})
