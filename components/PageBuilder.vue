<template>
  <div :class="['page-builder', { 'pbottom': removeTopPadding }]">
    <template v-for="(section, index) in sections" :key="section._id || index">
      ...
      <!-- <SectionHorizontalCarousel
        v-else-if="section._type === 'section' && section.sectionType === 'horizontalCarousel'"
        :section="section"
      /> -->

      <!-- Video Transition Section -->
      <!-- <SectionVideoTransition
        v-else-if="section._type === 'section' && section.sectionType === 'videoTransition'"
        :section="section"
      /> -->
...
import SectionVideoTransition from '~/components/SectionVideoTransition.vue'
